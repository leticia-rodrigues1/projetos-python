...
| Arquivo | Descrição |
|--------|---------|
| `variaveis.py` | Conceitos básicos de variáveis |
| `condicional.py` | Uso de if e else |
| `for.py` | Estruturas de repetição |
| `listas.py` | Trabalhando com listas |
| `tuplas.py` | Conceito de tuplas |
| `dicionarios.py` | Uso de dicionários |
| `funcoes.py` | Criação de funções |
| `inputs.py` | Entrada de dados pelo usuário |
| `textos.py` | Manipulação de strings |
| `codigo.py` | Primeiro código em Python |
